...
public class SignupFormWebpageFirefox extends SignupFormWebpage {
    @Inject
    public SignupFormWebpageFirefox(WebDriver driver) {
        super(driver);
        this.signupFormTitleLocator = By.cssSelector(".login-form");
        ...
        this.stateEntryLocator = By.id("id=state");
